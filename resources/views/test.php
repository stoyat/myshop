...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design" />
    ...
    <!--start-menu-->
    <script src="{{ asset('resources/assets/js/simpleCart.min.js') }}"> </script>
    <link href="{{ asset('resources/assets/css/memenu.css') }}" rel="stylesheet" type="text/css" media="all" />
    <script type="text/javascript" src="{{ asset('resources/assets/js/memenu.js') }}"></script>
    <script>$(document).ready(function(){$(".memenu").memenu();});</script>
    <!--dropdown-->
    <script src="{{ asset('resources/assets/js/jquery.easydropdown.js') }}"></script>
</head>
<body>
<!--top-header-->
